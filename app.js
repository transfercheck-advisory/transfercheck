const TRANSLATIONS = {
  "en": {
    ...
    "hero_lead": "TransferChek digitalizes and automates complex admissions data, providing elite-level strategy planning for a fraction of the cost. Instantly scan your eligibility, map prerequisite courses, build optimal term roadmaps, and structure winning essays.",
  ...
  "ko": {
    ...
    "hero_lead": "TransferChek은 유학원 수준의 정밀 편입 데이터를 자동화된 엔진으로 제공하는 유일한 프리미엄 솔루션입니다. 내 학점에 맞는 대학 진단부터 선수과목 매핑, 수강 계획 설계, 합격 에세이 개요 구성까지 성공적인 편입의 모든 준비 과정을 실시간으로 완벽하게 지원합니다.",
...
"stat_universities": "미국 전체 대학 지원",
  ...
  "zh": {
    ...
    "hero_lead": "TransferChek 将复杂的美国转学数据数字化和自动化，提供高性价比的顶尖策略规划。立即评估您的转学资格，对齐先修课程，定制学期路线图并构建出色的文书大纲。",
