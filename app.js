...
const TRANSLATIONS = {
  "en": {
    ...
    "site_title": "TransferChek | AI U.S. College Transfer Strategy Engine",
    "site_subtitle": "U.S. University Transfer Advisory",
    "refer_to_catalog_wording": "Refer to official catalog requirements below",
    "nav_pricing": "Pricing Plans",
    "nav_solution": "Services",
    "mobile_nav_eligibility": "Diagnostics",
    "mobile_nav_requirements": "Explorer",
    ...
    "ad_eligibility_b3": "Suggests optimal alternative target majors to maximize your admissions success rate.",
    "ad_eligibility_btn": "Start Free Eligibility Audit",
    "ad_requirements_title": "02. University & Major Explorer (ReqRadar)",
    "ad_requirements_headline": "Explore actual transfer rates, GPAs, and specimens for U.S. universities.",
    "ad_requirements_b1": "Accesses admitted GPA ranges, competitive English scores, and spec specimens.",
    "ad_requirements_b2": "Displays minimum course grades and target elective recommendations.",
    "ad_requirements_b3": "Provides strict filtering to prevent cross-school admitted case contamination.",
    "ad_requirements_btn": "Explore Universities & Majors",
    "ad_roadmap_title": "03. Prerequisite Roadmap (Pathfinder)",
    "ad_roadmap_headline": "Consolidate requirements for up to 7 target universities into one optimal roadmap.",
    "ad_roadmap_b1": "Automatically calculates prerequisite dependency chains (e.g. Calculus -> Physics -> CS).",
    "ad_roadmap_b2": "Optimizes course loads to fit strictly under transfer credit limits and protect your GPA.",
    "ad_roadmap_b3": "Schedules buffer semesters for professor recommendation letters and essay drafting.",
    "ad_roadmap_btn": "Build My Transfer Roadmap",
    "ad_essay_title": "04. AI Essay Planner (EssayAI)",
    "ad_essay_headline": "Craft winning narratives calibrated on 120,000+ accepted transfer essays.",
    "ad_essay_b1": "Extracts unique personal spike stories through a 5-step diagnostic AI interviewer.",
    ...
    "value_card1_title": "Professional Automation (Value of $20,000+)",
    "value_card1_body": "Instead of paying tens of thousands of dollars to traditional offline agencies, get digital consulting-grade prerequisite verification, roadmap sequence planning, and essay structure blueprinting.",
    "value_card2_title": "Synergy with Consulting Agencies",
    "value_card2_body": "Offline consulting thrives on personalized mentorship, while TransferChek delivers instant, validated data accuracy. Our engine acts as the perfect companion before and after agency visits, designed for hybrid B2B integration.",
    "value_card3_title": "Tuition Risk Prevention",
    "value_card3_body": "Missing even a single prerequisite can delay your transfer by a year, wasting tens of thousands of dollars in tuition and living costs. Prevent these expensive mistakes with a fraction of the cost.",
    "disclaimer_title": "📋 TransferChek Service Guidance & Data Integrity Policy",
    "disclaimer_body": "TransferChek integrates academic guidelines as a planning reference. Because university requirements (GPA caps, exam scores, prerequisites) change frequently, we recommend double-checking findings against official registrar portals. To guarantee accuracy, TransferChek runs automated audits (latest completed in June 2026) and maintains confidence badges.",
    "coverage_eyebrow": "Supported Elite Universities",
    "coverage_title": "Compare prerequisite course articulations across top-tier universities instantly.",
    ...
    "profile_desc": "Enter your current GPA, completed credits, residency, and coursework.",
    "label_gpa": "College GPA (out of 4.0)",
    "label_credits": "Completed Semester Credits",
    "label_international": "International Student",
    "label_english_type": "English Exam Type",
    "label_english_score": "Exam Score",
    ...
    "recommend_desc": "Target majors with high coverage score based on your academic profile. Subject to official verification.",
    "req_title": "University & Major Explorer",
    "req_desc": "Search any school or major to view transfer rates, GPA ranges, and specimens.",
    "label_search_school": "Search University or Major",
    "roadmap_title": "Prerequisite Roadmap Builder",
    ...
    "label_roadmap_target": "Target University & Major",
    "btn_build_roadmap": "Generate Prerequisite Roadmap",
    "essay_title": "AI Essay Planner",
    "essay_desc": "Input your key achievements to generate an admissions-focused essay blueprint.",
    "label_essay_target": "Target University & Major",
    "label_essay_activity": "Core Activities & Projects",
    "btn_generate_essay": "Generate Essay Blueprint",
    ...
    "feedback_eyebrow": "Feedback Hub",
    "feedback_title": "Help Improve Our Database Accuracy",
    ...
    "pricing_modal_upgrade": "Unlock Full Transfer Suite",
    "pricing_modal_subtitle": "Selecting the wrong class can cost you a semester's tuition. Secure your transfer with verified roadmaps.",
    "pricing_free_beta_notice": "🚀 Early-Bird Promo: All premium analysis tools and maps are currently free to try!",
    "active_plan_label": "Your Active Plan:",
    ...
    "tier_pro_feature1": "Unlimited evaluations in StatCompass",
    "tier_pro_feature2": "Dynamic Reach / Match / Safety classifications",
    ...
    "tier_essay_pass_feature1": "Unlimited critiques & narrative mappings for 1 target university",
    "tier_essay_pass_feature2": "Valid for 30 days from activation",
    "btn_choose_plan": "Upgrade Plan",
    ...
    "roadmap_multi_notice_title": "Planning for {count} Target Universities (Merged)",
    "roadmap_multi_notice_desc": "Prerequisites combined from: ",
    "roadmap_multi_warning": "Selecting more target universities may increase the required duration of coursework.",
    "roadmap_targets_label": "Roadmap Target Universities (Max 7)",
    "req_finder_placeholder_title": "Search Target Major",
    ...
    "no_targets_selected": "No target universities selected.",
    ...
    "req_search_placeholder": "Type school name or major...",
    ...
    "guide_s4_tip": "💡 Platform Tip: Use [03. Roadmap Builder] to map out core prerequisites and major course sequences in the correct logical order.",
    "guide_s5_body": "The final differentiator is your essay and extracurriculars. Connect your projects, clubs, and academic experiences to show academic alignment with target department values.",
    "search_missing_prompt": "Can't find your target university or major?",
    "search_missing_link": "Request AI Real-Time Generation (100% Major Coverage)",
    "gen_modal_subtitle": "100% Major Coverage",
    "gen_modal_title": "AI Real-Time Prerequisite Generator",
    "gen_modal_desc": "Enter any US university and major (e.g. Stanford University - Economics) to instantly crawl/generate transfer prerequisites, minimum GPA, and course mappings using Gemini 2.0.",
    "label_gen_school": "University / College Name",
    "label_gen_major": "Major / Program Name",
    "gen_loading_text": "AI is searching and extracting transfer requirements... (Takes about 3-5 seconds)",
    "btn_gen_req": "Generate Prerequisite Profile",
    "drawer_nav1_title": "01. Eligibility Diagnostics",
    "drawer_nav1_desc": "Input your metrics to check admission coverage",
    "drawer_nav2_title": "02. Prerequisite Finder",
    "drawer_nav2_desc": "Search databases for credit transfer and GPA thresholds",
    "drawer_nav3_title": "03. Roadmap Builder",
    "drawer_nav3_desc": "Term-by-term prerequisite sequence compliance planner",
    "drawer_nav4_title": "04. EssayAI & Interview Prep",
    "drawer_nav4_desc": "AI essay guidelines and mock interview mapping",
    "drawer_nav_guide_title": "5-Step Transfer Strategy Guide",
    "drawer_nav_guide_desc": "Structured roadmap for top-tier transfer preparation",
    "drawer_nav_pricing_title": "Membership Pricing",
    "drawer_nav_pricing_desc": "Check free and premium plan options",
    "cases_showcase_eyebrow": "Admissions Specimen Database",
    "cases_showcase_heading": "Analyze Admission Specimen Database Compiled from Public Datasets",
    "cases_showcase_desc": "Explore anonymized historical transfer profiles compiled from public university datasets and community reports. This reference database represents external admitted statistics to help you benchmark your transfer candidacy, not direct client results of this service.",
    "case_showcase_c1_title": "STEM: CS Transfer",
    "case_showcase_status": "Admitted Sample",
    "label_case_gpa": "GPA:",
    "label_case_origin": "Origin CC:",
    "case_showcase_c1_origin": "De Anza College",
    "label_case_extra": "Key Extracurriculars:",
    "case_showcase_c1_extra": "Built a React scheduling app, tutored calculus, joined Robotics Club.",
    "case_showcase_c2_title": "Business: Finance",
    "case_showcase_status_haas": "Admitted Sample (Haas)",
    "case_showcase_c2_origin": "Diablo Valley College",
    "case_showcase_c2_extra": "Summer audit internship, President of CC Finance & Investment Society.",
    "case_showcase_c3_title": "Humanities: Psych",
    "case_showcase_status_ucla": "Admitted Sample (UCLA)",
    "case_showcase_c3_origin": "Santa Monica College",
    "case_showcase_c3_extra": "Crisis text line counselor, volunteer research assistant in cognitive lab.",
    "cases_showcase_cta_note": "Explore all target universities and unlock complete success profiles. *Note: Specimen data are reference examples compiled from public statistics, not direct client admissions.",
    "btn_cases_showcase": "Explore Database in ReqRadar",
    "ph_coverage_title": "Canonical Prerequisite Database",
    "ph_coverage_desc": "Comprehensive coverage of top target U.S. universities",
    "guide_section_eyebrow": "Successful Transfer Strategy",
    "guide_heading": "5-Step Success Strategy for Top-Tier University Transfer",
    "guide_desc": "Transferring to top universities begins with strategic course planning and rigorous prerequisite verification. Review the 5-step success strategy below to understand how to maximize your admission chances using our platform.",
    "guide_swipe_hint": "← Swipe horizontally to view all 5 steps →",
    "track_btn_stem": "STEM Track",
    "track_btn_business": "Business Track",
    "track_btn_humanities": "Humanities Track",
    "guide_bottom_btn": "Start My Transfer Eligibility Diagnostics",
    "ph_diagnostics_title": "Eligibility Diagnostics",
    "ph_diagnostics_desc": "Input your metrics to check admission coverage",
    "label_track": "Academic Track / Major Area",
    "track_option_stem": "STEM (Engineering & Sciences)",
    "track_option_business": "Business (Management & Economics)",
    "track_option_humanities": "Humanities & Social Sciences",
    "lock_requirements_title": "Premium Plan Required",
    "lock_requirements_desc": "Upgrade to Premium to search and view prerequisite course articulations and minimum GPA thresholds for top target universities.",
    "ph_finder_title": "Prerequisite Articulation Finder",
    "ph_finder_desc": "Search databases for credit transfer and GPA thresholds",
    "lock_roadmap_title": "Premium Plan Required",
    "lock_roadmap_desc": "Upgrade to Premium to build optimized, term-by-term prerequisite roadmaps with academic coursework and non-academic advisory milestones.",
    "ph_roadmap_title": "Prerequisite Roadmap compliance planner",
    "ph_roadmap_desc": "Term-by-term prerequisite sequence compliance planner",
    "lock_essay_title": "Premium Plan or Essay Pass Required",
    "lock_essay_desc": "Upgrade to Premium or purchase a single target school Essay Pass to access the AI Essay outline planner and writing clinic.",
    "essay_subtab_critic": "Critic & Clinic",
    "essay_subtab_mapper": "Narrative Mapper",
    "essay_subtab_optimizer": "Activity Optimizer",
    "ph_feedback_title": "Anonymous Feedback Hub",
    "ph_feedback_desc": "Your suggestions directly improve our database accuracy",
    "footer_title": "TransferChek",
    "footer_rep_label": "Representative:",
    "footer_rep_val": "Hamin Kim",
    "footer_email_label": "Email:",
    "footer_biz_num_label": "Business Registration:",
    "footer_tele_num_label": "Mail Order Registration:",
    "footer_tele_num_val": "Preparing registration",
    "footer_address_label": "Address:",
    "footer_address_val": "21-1, Pilmun-daero 153beon-gil, Dong-gu, Gwangju, Republic of Korea",
    "footer_phone_label": "Tel:",
    "footer_links_title": "Support & Policies",
    ...
    "nationality_korea": "South Korea (대한민국)",
    "nationality_usa": "United States (미국)",
    "nationality_china": "China (중국)",
    "nationality_other": "Other (기타)",
  ...
  "ko": {
    ...
    "ad_requirements_b3": "데이터 검증 상태(Verified / Needs Review)를 명확히 표시하여 정보 오류 리스크를 최소화합니다.",
    "ad_requirements_btn": "선수과목 이수 조건 검색하기",
    "ad_roadmap_title": "03. 수강 로드맵 빌더 (Pathfinder)",
    "ad_roadmap_headline": "여러 타겟 대학의 서로 다른 요건을 완벽히 흡수하는 단 하나의 최적 학기별 로드맵.",
    "ad_roadmap_b1": "복잡한 선수과목 순서 연결고리(미적분학 -> 일반물리 -> 전공 기초)를 고려하여 일정을 자동 구성합니다.",
    "ad_roadmap_b2": "학기당 이수 학점 한도 내에서 가장 안전하게 GPA를 보존할 수 있도록 배정합니다.",
    "ad_roadmap_b3": "교수 추천서 요청, 공인어학성적 제출, 에세이 초안 작성 시점 등 입시 마일스톤을 동시 제공합니다.",
    "ad_roadmap_btn": "최적 수강 로드맵 빌드하기",
    "ad_essay_title": "04. AI 에세이 설계 (EssayAI)",
    "ad_essay_headline": "120,000 건의 실제 편입 합격 에세이 합격 데이터를 분석해 추출한 고효율 스토리라인 설계.",
    "ad_essay_b1": "5단계 심층 인터뷰 형식으로 전공 적합성을 가장 잘 드러낼 수 있는 숨겨진 활동을 적출합니다.",
    ...
    "value_card1_title": "오프라인 컨설팅의 디지털 자동화",
    "value_card1_body": "수천만 원 상당의 유학원 오프라인 컨설팅에서 수행하는 복잡한 선수과목 검증, 최적 학기 로드맵 배치, 에세이 방향성 설계를 엔진에 그대로 녹여내어 단 29,000원에 실시간 무제한으로 누릴 수 있습니다.",
    "value_card2_title": "오프라인 유학원과의 하이브리드 시너지",
    "value_card2_body": "유학원의 세심한 휴먼 멘토링과 TransferChek의 정밀한 데이터 엔진이 결합될 때 합격률이 극대화됩니다. 유학원 상담 전후의 필수 자가 점검 도구이자 B2B 협업 파트너로서 조화롭게 공존합니다.",
    "value_card3_title": "유학 비용 낭비 및 지연 리스크 예방",
    "value_card3_body": "선수과목 조건 하나만 놓쳐도 편입 지원 타이밍이 1년 밀려 수천만 원의 현지 체류비와 학비가 낭비됩니다. 커피 몇 잔 값의 투자로 수천만 원 상당의 잠재적 리스크를 미연에 완벽히 예방할 수 있습니다.",
    "disclaimer_title": "📋 TransferChek 학업 정보 안내 및 서비스 고지",
    "disclaimer_body": "TransferChek은 미국 명문대 편입 요강을 통합 정리하여 효율적인 계획 수립을 돕는 데이터 분석 도구입니다. 각 대학의 최소 GPA, 필수 선수과목, 어학 성적 등 입학 조건은 학교 측 정책에 따라 수시로 변동될 수 있습니다. 본 플랫폼의 진단 결과와 로드맵을 참고용 가이드로 활용하시되, 최종 지원서 접수 전 각 대학 공식 홈페이지 정보를 최종 확인하시는 것을 권장합니다. TransferChek는 신뢰도 높은 서비스 제공을 위해 상시 데이터 검증(2026년 6월 최종 검사 완료)을 성실히 수행하고 있습니다.",
    "coverage_eyebrow": "분석 지원 대학교",
    "coverage_title": "명문 대학교들의 편입 선수 과목 요건을 한자리에서 비교 확인하세요.",
    ...
    "pricing_modal_upgrade": "미국 명문대 편입 요건 무제한 해제",
    "pricing_modal_subtitle": "수강 실수로 인한 한 학기 학비 낭비는 약 1,500만 원에 달합니다. 안전하고 검증된 계획으로 명문대 합격 가능성을 극대화하세요.",
    "pricing_free_beta_notice": "🚀 얼리버드 프로모션: 프리미엄 수강 로드맵 및 에세이 설계 기능 즉시 무료 체험 진행 중!",
    ...
    "tier_pro_feature1": "지원 가능 판단 내 목표 대학/학과 무제한 분석 지원",
    ...
    "tier_essay_pass_feature1": "선택한 학교/학과/에세이 질문에 맞춘 AI 문단 첨삭 및 소재 추천 (30일 무제한)",
    "tier_essay_pass_feature2": "실제 합격 사례 기반의 합격 전략 영문 서술 가이드 제공",
    "btn_choose_plan": "플랜 선택 및 업그레이드",
    ...
    "badge_verified_tag": "✓ 공식 요강 검증 완료",
    "badge_high_risk_tag": "⚠ 개별 확인 요망",
    "badge_needs_review_tag": "⚠ 일부 정보 재확인 요망",
    ...
    "req_search_placeholder": "대학 이름 또는 전공을 입력하세요...",
    ...
    "essay_style_guide_title": "해당 대학 편입 에세이 심사 기준 & 스타일 가이드",
    ...
    "essay_info_banner_body": "본 AI 엔진은 미국 주요 명문 대학교의 편입 요건뿐만 아니라, 120,000건 이상의 실제 명문대 합격 에세이 패턴 분석 데이터에 기반하여 정교하게 칼리브레이션되어 있습니다. 입력하신 학생 활동을 최적의 뼈대로 엮는 브레인스토밍 가이드를 제공하며, 대학의 학업적 성실성 원칙에 의거하여 대필은 제공하지 않으며 입학을 보장하지 않습니다.",
    "essay_mode_direct": "직접 입력",
    "essay_mode_interview": "AI 인터뷰 가이드",
    "interview_start_desc": "목표 대학 및 학과에 특화된 5가지 질문에 답변하며 본인의 핵심 전공 활동과 성향을 빠짐없이 이끌어내세요.",
...
"stat_universities": "미국 전체 대학 지원",
    ...
    "ph_coverage_desc": "미국 전역 대학교의 편입 요건 보유",
    "lock_requirements_desc": "미국 명문 대학교들의 상세 선수과목 조건과 합격생 평균 학점 컷(GPA Threshold)을 조회하려면 프리미엄 멤버십으로 업그레이드하세요.",
    "guide_heading": "미국 명문대 합격을 위한 5단계 성공 전략",
    "guide_desc": "미국 명문 대학교 편입은 체계적인 수강 계획과 철저한 선수과목 검증에서 시작됩니다. 아래 5단계 성공 전략을 확인하고, 본 플랫폼의 기능을 어떻게 연계하여 합격률을 극대화할 수 있는지 파악하십시오.",
    "guide_s1_title": "01. 목표 대학 및 전공 탐색 (Target Research)",
    "guide_s1_body": "자신이 편입하고자 하는 대학교와 전공을 명확히 정의합니다. 각 대학의 입학처 요강과 정량적 합격 지표(GPA, 최저 학점)를 먼저 검토해야 합니다.",
    "guide_s2_body": "미국 명문대 편입 심사에서 선수과목(Prerequisites) 이수 여부는 절대적입니다. 전공 분야별 핵심 수학, 과학, 기초 필수 과목 중 하나라도 누락되면 서류 심사에서 불이익을 받거나 탈락 처리될 수 있습니다.",
    "guide_s4_tip": "💡 플랫폼 활용 팁: [03. 수강 로드맵 빌더]를 통해 복잡하게 꼬이기 쉬운 수학, 과학, 전공 필수 과목들을 최적의 논리적 순서로 구성해 보십시오.",
    "guide_s5_body": "상위권 대학 편입 합격을 결정짓는 마지막 열쇠는 에세이(Personal Statement / SOP)와 모의 면접입니다. 본인의 학업 성과(GPA)와 더불어, 교내외 동아리, 전공 프로젝트, 학술 성과 등을 관심사와 결합하여 설득력 있는 스토리로 전달해야 합니다.",
    "search_missing_prompt": "원하는 대학교나 전공이 리스트에 없나요?",
    "search_missing_link": "AI 실시간 요건 생성 요청 (100% 전공 커버)",
    "gen_modal_subtitle": "100% 전공 데이터 커버리지",
    "gen_modal_title": "AI 실시간 편입 요건 생성기",
    "gen_modal_desc": "리스트에 없는 미국 대학교와 전공명(예: Stanford University - Economics)을 입력해 주시면, Gemini 2.0을 통해 실시간으로 편입 선수과목, 최소 GPA 및 영어 점수 규정을 분석하여 생성합니다.",
    "label_gen_school": "대학교 공식 영문 이름",
    ...
    "drawer_nav4_desc": "AI 에세이 가이드라인 및 합격 서술 전략 구성",
    "drawer_nav_guide_title": "5단계 편입 성공 전략 가이드",
    "drawer_nav_guide_desc": "체계적이고 검증된 미국 대학 편입 준비 로드맵",
    "drawer_nav_pricing_title": "멤버십 요금제",
    "drawer_nav_pricing_desc": "무료 및 프리미엄 요금제 혜택 확인",
    "cases_showcase_eyebrow": "편입 합격 표본 데이터베이스 공개",
    "cases_showcase_heading": "공개 데이터 기반 합격생 표본 데이터 분석",
    "cases_showcase_desc": "대학 공식 공시 자료 및 편입 커뮤니티의 합격 사례 통계 데이터를 학습·분석하여 구성한 참고용 표본 데이터베이스입니다. 본 웹사이트를 통한 직접 합격 실적이 아닌, 학습된 외부 데이터 기반의 학업 분석 정보입니다.",
    "case_showcase_c1_title": "STEM: 컴퓨터공학 편입",
    "case_showcase_status": "합격 사례 표본",
    "label_case_gpa": "GPA:",
    "label_case_origin": "전적대/CC:",
    "case_showcase_c1_origin": "디안자 칼리지",
    "label_case_extra": "핵심 비교과 활동:",
    "case_showcase_c1_extra": "React 시간표 앱 개발, 미적분학 튜터링, 로보틱스 클럽 참여.",
    "case_showcase_c2_title": "경영/상경계열 편입",
    "case_showcase_status_haas": "합격 사례 표본 (버클리 하스)",
    "case_showcase_c2_origin": "디아블로 밸리 칼리지",
    "case_showcase_c2_extra": "회계법인 여름 감사 인턴십, 교내 금융/투자 학회 회장 역임.",
    "case_showcase_c3_title": "인문/사회계열 편입",
    "case_showcase_status_ucla": "합격 사례 표본 (UCLA 심리학)",
    "case_showcase_c3_origin": "산타모니카 칼리지",
    "case_showcase_c3_extra": "청소년 위기 텍스트 라인 상담가, 인지심리 연구소 연구 조원 봉사.",
    "cases_showcase_cta_note": "무료 플랜에서도 모든 대학 요건을 생성/조회할 수 있습니다. 프리미엄 업그레이드 시 전체 합격 데이터베이스를 잠금해제합니다. *참고: 본 표본은 공개 통계 기반 자료이며 본 서비스의 직접적 합격 실적이 아닙니다.",
    "btn_cases_showcase": "ReqRadar에서 합격 데이터베이스 조회하기",
    "ph_coverage_title": "공식 편입 선수과목 데이터베이스",
    "guide_section_eyebrow": "성공적인 명문대 편입 전략",
    "guide_swipe_hint": "← 모든 단계를 보려면 가로로 스와이프하세요 →",
    "track_btn_stem": "STEM 계열",
    "track_btn_business": "상경/경영 계열",
    "track_btn_humanities": "인문/사회 계열",
    "guide_bottom_btn": "내 편입 지원 자격 진단 시작하기",
    "ph_diagnostics_title": "지원 자격 진단",
    "ph_diagnostics_desc": "이수 요건과 성적을 입력하여 지원 가능 여부를 확인하세요",
    "label_track": "학업 계열 / 전공 분야",
    "track_option_stem": "STEM (공학 및 자연과학)",
    "track_option_business": "비즈니스 (경영 및 경제)",
    "track_option_humanities": "인문학 및 사회과학",
    "lock_requirements_title": "프리미엄 요금제 필요",
    "ph_finder_title": "선수과목 이수 조건 검색기",
    "ph_finder_desc": "각 대학/학과별 학점 및 과목 이수 규정 조회",
    "lock_roadmap_title": "프리미엄 요금제 필요",
    "lock_roadmap_desc": "학기별 필수 선수과목 이수 최적화 및 비학업적인 편입 일정을 구성하려면 프리미엄 멤버십으로 업그레이드하세요.",
    "ph_roadmap_title": "학기별 최적 수강 로드맵 빌더",
    "ph_roadmap_desc": "선수과목 순서 의존성을 고려한 논리적 수강 계획표",
    "lock_essay_title": "프리미엄 요금제 혹은 에세이 패스 필요",
    "lock_essay_desc": "AI 에세이 스토리라인 설계도 및 작문 문단 클리닉을 활성화하려면 프리미엄 멤버십으로 업그레이드하거나 에세이 패스를 구매하세요.",
    "essay_subtab_critic": "에세이 문단 클리닉 (Critic & Clinic)",
    "essay_subtab_mapper": "소재 & 스토리 매핑 (Narrative Mapper)",
    "essay_subtab_optimizer": "활동 이력 압축기 (Activity Optimizer)",
    "ph_feedback_title": "익명 피드백 허브",
    "ph_feedback_desc": "보내주시는 제안사항은 데이터베이스 정확도 개선에 활용됩니다",
    "footer_title": "트랜스퍼체크 (TransferChek)",
    "footer_rep_label": "대표자명:",
    "footer_rep_val": "김하민",
    "footer_email_label": "이메일:",
    "footer_biz_num_label": "사업자등록번호:",
    "footer_tele_num_label": "통신판매업신고번호:",
    "footer_tele_num_val": "신고 준비 중",
    "footer_address_label": "주소:",
    "footer_address_val": "광주광역시 동구 필문대로153번길 21-1 (산수동)",
    "footer_phone_label": "유선번호:",
    "footer_links_title": "고객지원 & 약관",
    "footer_link_pricing": "요금제 안내 (Pricing Plans)",
    "footer_link_terms": "서비스 이용약관 (Terms of Service)",
    "footer_link_privacy": "개인정보 처리방침 (Privacy Policy)",
    "footer_link_refund": "환불 및 해지 정책 (Refund Policy)",
    "label_nationality": "국적",
    "nationality_korea": "대한민국 (South Korea)",
    "nationality_usa": "미국 (United States)",
    "nationality_china": "중국 (China)",
    "nationality_other": "기타 (Other)",
  ...
  "zh": {
    ...
    "nav_pricing": "订阅会员方案",
    "nav_solution": "主要服务",
    "mobile_nav_eligibility": "资格评估",
    "mobile_nav_requirements": "先修课程",
    "mobile_nav_roadmap": "选课路线",
    "mobile_nav_essay": "文书AI",
    "mobile_nav_pricing": "会员方案",
    ...
    "ad_eligibility_b1": "一键瞬间比对全美名校官方录取准入门槛。",
    ...
    "ad_requirements_b1": "汇聚全美名校的官方先修要求，专业名称与课号一目了然。",
    ...
    "ad_roadmap_b1": "自动解析前置课程依赖链，防止课程顺序错乱。",
    ...
    "ad_essay_headline": "融合 120,000+ 篇名校成功转学文书的套路与规律。",
    ...
    "value_card1_title": "专业咨询服务数字化自动实现 (价值29,000韩元)",
    "value_card1_body": "无需向传统的线下中介支付高昂的咨询费。我们为您提供实时的、无限制的高端先修课程验证、学期课程路径规划和文书策略大纲设计。",
    "value_card2_title": "与线下留学中介和谐共生与协同",
    "value_card2_body": "线下留学中介长于个性化的导师指导，而 TransferChek 则提供即时且验证过的数据精准性。我们的引擎是您访问中介前后的完美自检工具，专为混合B2B集成而设计。",
    "value_card3_title": "学费损失与转学延期风险预防",
    "value_card3_body": "遗漏一门先修课程可能会使您的转学时间延迟一年，浪费数万美元的学费和生活费。只需一杯咖啡的钱，即可彻底避免这些高昂的错误风险。",
    "disclaimer_title": "📋 TransferChek 学业信息指南与特别说明",
    "disclaimer_body": "TransferChek 是一款旨在整合美国名校转学要求并帮助您制定高效规划的数据分析工具。各大学的最低 GPA、先修课程和语言要求等录取条件可能会根据校方政策随时变动。请将本平台的评估结果 and 路线图作为参考指南，并建议在正式提交申请前与目标大学官方招生网站的信息进行最终核对。TransferChek 持续进行数据验证（最新审核完成于 2026 年 6 月），以全力支持您的转学旅程。",
    "coverage_eyebrow": "已覆盖大学",
    "coverage_title": "一站式比对顶尖大学的先修课程和录取标准。",
    ...
    "req_search_placeholder": "输入大学名称或专业...",
    ...
    "essay_style_guide_title": "该大学转学文书评审标准与风格指南",
    "tag_dos": "建议阐述方向 (DOs)",
    "tag_donts": "应避免的误区 (DON'Ts)",
    "tag_example": "优秀英文写作范例",
    "essay_info_banner_title": "AI 知识库状态与法律特别说明",
    "essay_info_banner_body": "本 AI 引擎已针对美国顶尖大学 the 转学录取标准 and 文书风格指南（如 UC PIQ、佐治亚理工的贡献/协作导向、UIUC 的研究拟合度等）进行了深度校准，并融入了 120,000+ 篇成功转学文书的模式分析数据。系统将分析您的项目活动并为您生成最佳篇章叙事蓝图。为了遵守大学防剽窃及学术诚信政策，本服务为纯教育辅助工具，不提供文书代写服务，亦不担保最终录取结果。",
    "essay_mode_direct": "直接输入",
    "essay_mode_interview": "AI 互动面试指南",
    "interview_start_desc": "针对目标院校及专业回答 5 个定制问题，全面挖掘您的核心项目经历和学术特质。",
    ...
    "stat_universities": "覆盖全美高校",
    "stat_programs": "专业覆盖度 (AI 实时)",
    ...
    "gen_modal_title": "AI 实时先修要求生成器",
    "gen_modal_desc": "输入任何美国大学和专业（例如 Stanford University - Economics），即可使用 Gemini 2.0 立即检索/生成转学先修要求、最低 GPA 和课程映射。",
    "label_gen_school": "大学官方英文名称",
    "label_gen_major": "专业 / 项目英文名称",
    "gen_loading_text": "AI 正在检索和提取转学要求...（需要大约 3-5 秒）",
    "btn_gen_req": "生成先修课程档案",
    "drawer_nav1_title": "01. StatCompass",
    "drawer_nav1_desc": "转学可行性分析",
    "drawer_nav2_title": "02. ReqRadar",
    "drawer_nav2_desc": "先修课程搜索引擎",
    "drawer_nav3_title": "03. Pathfinder",
    "drawer_nav3_desc": "最优选课路线规划",
    "drawer_nav4_title": "04. EssayAI",
    "drawer_nav4_desc": "转学文书策略家",
    "drawer_nav_guide_title": "5步转学策略指南",
    "drawer_nav_guide_desc": "系统化的顶尖大学转学准备路线图",
    "drawer_nav_pricing_title": "会员订阅计划",
    "drawer_nav_pricing_desc": "查看免费和高级计划选项",
    "cases_showcase_eyebrow": "录取案例样本数据库",
    "cases_showcase_heading": "分析从公开数据集编译的录取案例样本数据库",
    "cases_showcase_desc": "探索从公开大学数据集和社区报告中编译的匿名历史转学档案。此参考数据库代表外部录取统计数据，以帮助您基准测试您的转学候选资格，而不是此服务的直接客户结果。",
    "case_showcase_c1_title": "STEM: CS转学",
    "case_showcase_status": "录取样本",
    "label_case_gpa": "GPA:",
    "label_case_origin": "来源CC:",
    "case_showcase_c1_origin": "迪安萨学院",
    "label_case_extra": "关键课外活动:",
    "case_showcase_c1_extra": "构建了 React 日程安排应用程序，辅导微积分，加入了机器人俱乐部。",
    "case_showcase_c2_title": "商科: 金融",
    "case_showcase_status_haas": "录取样本 (哈斯)",
    "case_showcase_c2_origin": "帝亚布罗谷学院",
    "case_showcase_c2_extra": "暑期审计实习，社区大学金融与投资协会主席。",
    "case_showcase_c3_title": "人文: 心理",
    "case_showcase_status_ucla": "录取样本 (UCLA)",
    "case_showcase_c3_origin": "圣莫尼卡学院",
    "case_showcase_c3_extra": "危机短信专线辅导员，认知实验室志愿研究助理。",
    "cases_showcase_cta_note": "探索所有目标大学并解锁完整的成功档案。*注意：样本数据是根据公开统计数据编译的参考示例，不是该服务的直接客户录取结果。",
    "btn_cases_showcase": "在 ReqRadar 中探索数据库"
  }
};
...
const STRATEGY_DATA = {
  en: {
    stem: [
      ...
      {
        title: "Academic Scheduling & Term Sequencing",
        body: "Plan your coursework sequence logically (e.g. Calculus 1 -> Calculus 2 -> Physics 1). Ensure you complete critical prerequisites before applying, and maintain a high GPA.",
    ...
    business: [
      {
        title: "Target Business School Research",
        body: "Identify top business schools (e.g., Foster, Olin, Ross, Haas). Note strict application deadlines, specific minimum GPAs, and average admitted stats.",
        tip: "💡 Platform Tip: Use [01. Eligibility Diagnostics] to evaluate your cumulative credentials against top business school expectations."
      },
      {
        title: "Core Business & Economics Prerequisites",
        body: "Complete core prerequisites: Calculus, Business Statistics, Microeconomics, Macroeconomics, Financial Accounting, and Managerial Accounting. High grades (A/B) in these courses are essential.",
        tip: "💡 Platform Tip: Use [02. Prerequisite Finder] to check accounting and economics course articulation requirements for your target schools."
      },
      {
        title: "CC Selection & Business Articulations",
        body: "Choose a community college with established business transfer pathways. Check if your CC credits are accepted for business-specific core requirements, not just general education.",
        tip: "💡 Platform Tip: Verify whether your CC offers direct articulation agreements or guaranteed admission pathways for business."
      },
      {
        title: "GPA Preservation & Application Timing",
        body: "Business transfers are extremely competitive. Structure your terms to complete pre-application courses early, allowing you to showcase strong grades in accounting and economics.",
        tip: "💡 Platform Tip: Use [03. Roadmap Builder] to outline your economics and accounting course sequences without overloading any single semester."
      },
      {
        title: "Leadership, Internships & Career Focus",
        body: "Highlight leadership roles, business clubs, internships, and volunteer work. Your admissions essays must clearly detail your career vision, leadership capacity, and professional goals.",
        tip: "💡 Platform Tip: Use [04. EssayAI] to craft compelling essays highlighting your startup projects, case competitions, or finance internship experiences."
      }
    ],
    humanities: [
      {
        title: "Identify Majors & Liberal Arts Targets",
        body: "Choose your major track (Psychology, Economics BA, History, Sociology, etc.). Note specific foreign language requirements and general education (GE) frameworks.",
        tip: "💡 Platform Tip: Use [01. Eligibility Diagnostics] to check how your current credits satisfy target liberal arts guidelines."
      },
      {
        title: "General Education & Core Requirements",
        body: "Focus on completing writing-intensive English Composition 1 & 2, introductory social sciences (e.g. Psychology, Sociology), humanities (e.g. History, Philosophy), and public speaking.",
        tip: "💡 Platform Tip: Use [02. Prerequisite Finder] to inspect general education requirements and foreign language exemptions for your target major."
      },
      {
        title: "General Education Pathways (IGETC, etc.)",
        body: "Many state systems prioritize students who complete a structured GE package (like IGETC for UC). Voluminous credit transfer is easier when adhering to these structured pathways.",
        tip: "💡 Platform Tip: Choose courses that satisfy multiple breadth requirements (like social science + international focus) to save credits."
      },
      {
        title: "Reading/Writing Volume & GPA Management",
        body: "Balance reading-heavy and writing-heavy courses across semesters. Maintain a high GPA by spacing out intensive term papers and exam-heavy coursework.",
        tip: "💡 Platform Tip: Use [03. Roadmap Builder] to schedule your writing and humanities courses evenly, leaving ample preparation time."
      },
      {
        title: "Critical Writing, Research & SOP Prep",
        body: "Demonstrate strong analytical writing, research assistant experience, or community service. Your Statement of Purpose (SOP) must explain your intellectual curiosity and fit for the major.",
        tip: "💡 Platform Tip: Use [04. EssayAI] to refine and structure your statement of purpose paragraphs, ensuring a professional and persuasive academic tone."
      }
    ]
  },
  ko: {
    stem: [
      ...
      },
      {
        ...
        body: "미국 주립대들은 본인이 속한 주의 커뮤니티 칼리지(CC) 출신 편입생에게 전형 상 가산점과 우선선발권(예: UC 계열의 TAG 협약 등)을 보장합니다. 목표 대학교와 동일한 주에 위치한 CC 혹은 주립대에서 편입을 개시하는 것이 합격 확률 및 학점 인정(Credit Transfer) 측면에서 압도적으로 유리합니다.",
        tip: "💡 플랫폼 활용 팁: 저희 데이터베이스가 제공하는 캘리포니아, 텍사스, 미시간 등 주(State)별 매핑 분석을 참고하여, 목표 대학교로의 편입 성공률을 높여주는 우수 CC 리스트와 필수 조건을 파악하십시오."
      },
      {
        title: "체계적인 수강계획 수립 및 철저한 GPA 관리 (Academic Scheduling)",
        body: "편입 요건을 충족하는 과목들을 우선적으로 이수하기 위해 학기별 수강 순서를 세밀하게 기획해야 합니다. 선이수 필수 조건(Pre-requisites)이나 개설 학기 제약이 있으므로, 학기 설계에 작은 오류가 있어도 편입 시기가 6개월에서 1년 이상 미뤄질 수 있습니다.",
        tip: "💡 플랫폼 활용 팁: [03. 수강 로드맵 빌더]를 통해 복잡하게 꼬이기 쉬운 기초 수학, 물리, 전공 탐색 과목들을 최적의 논리적 순서로 구성해 보십시오."
      },
      {
    ...
    business: [
      {
        title: "목표 경영대학 및 입학 기준 조사 (Target Research)",
        body: "자신이 편입하고자 하는 목표 경영대학(예: Foster, Olin, Ross, Haas 등)을 설정합니다. 경영대 편입은 입학 정원이 제한되어 있으며, 별도의 에세이 제출 및 인터뷰 조건, 그리고 매우 높은 GPA 컷오프를 요구하는 경우가 많습니다.",
        tip: "💡 플랫폼 활용 팁: [01. 지원 가능 판단] 기능에서 현재 GPA와 취득 학점을 입력하여 각 타겟 경영대학의 합격선 및 지원 가능 여부를 확인해 보십시오."
      },
      {
        title: "경영/경제 필수 선수과목 최우선 이수 (Prerequisite Mapping)",
        body: "경영학 편입을 위해서는 미적분학, 비즈니스 통계학, 미시경제학, 거시경제학, 재무회계 및 관리회계 등의 과목을 반드시 우수한 성적(A/B)으로 이수해야 합니다. 필수 상경 선수과목이 부족하면 심사에서 크게 불리합니다.",
        tip: "💡 플랫폼 활용 팁: [02. 편입 요건 검색] 기능에서 목표 경영학과를 선택하여 공식 경영대 가이드라인과 연동된 선수과목 리스트 및 학점 요구사항을 검색해 보십시오."
      },
      {
        title: "주별 경영대 인정 CC 및 학점 매핑 (CC Selection)",
        body: "경영대학들은 타 전공 대비 까다로운 비즈니스 핵심 과목의 학점 인정(Credit Evaluation)을 고수합니다. 목표 대학과 학점 연동이 원활한 CC를 선택하고, 이수한 전공 수업이 일반 교양이 아닌 전공 필수 학점으로 확실히 인정받는지 검증해야 합니다.",
        tip: "💡 플랫폼 활용 팁: 각 대학교의 편입 인정 기준 및 주별 매핑 가이드라인을 참조하여 불필요하게 버려지는 학점을 최소화하십시오."
      },
      {
        title: "경쟁력 있는 GPA 유지 및 수강 학기 최적화 (Academic Scheduling)",
        body: "상위권 경영대 편입은 경쟁이 매우 치열하므로, GPA 관리가 핵심입니다. 비교적 난이도가 높은 회계 및 통계 수업을 적절히 분산 배치하고, 편입 지원 전 학기까지 대부분의 상경 필수 과목 이수를 완료하여 우수한 학업 성과를 증명해야 합니다.",
        tip: "💡 플랫폼 활용 팁: [03. 수강 로드맵 빌더]를 통해 경영대 편입에 필수적인 경제, 회계 과목들의 일정을 최적의 논리적 순서로 구성해 보십시오."
      },
      {
        title: "리더십, 인턴십 및 에세이 스토리 설계 (Qualitative Assets)",
        body: "성공적인 경영대 편입에는 교내 동아리 임원 활동, 비즈니스 공모전, 인턴십 및 창업 경험 등 본인의 리더십과 정성적 성과가 크게 반영됩니다. 에세이를 통해 장래의 커리어 비전과 비즈니스 마인드를 효과적으로 어필하십시오.",
        tip: "💡 플랫폼 활용 팁: [04. AI 에세이 전략가]를 통해 경영대 고유의 리더십 및 목표 지향적 에세이 질문에 맞춘 강력한 영문 아웃라인과 모의 면접 답변을 설계해 보십시오."
      }
    ],
    humanities: [
      {
        title: "목표 인문/사회계열 학과 및 요건 검토 (Target Research)",
        body: "심리학, 경제학(BA), 역사학, 사회학, 언론정보학 등 목표로 하는 인문/사회과학 전공의 지원 요건을 확인합니다. 해당 전공들은 주립대와 사립대에 따라 교양 필수 범위와 외국어 이수 요건이 크게 상이합니다.",
        tip: "💡 플랫폼 활용 팁: [01. 지원 가능 판단] 시뮬레이션에서 현재 성적을 토대로 인문/사회계열 편입의 필수 요건 통과율을 실시간으로 확인해 보십시오."
      },
      {
        title: "교양(General Education) 및 쓰기 과목 이수 (Prerequisite Mapping)",
        body: "인문사회계열 편입생은 광범위한 독서 및 작문 능력을 입증해야 합니다. 영어 작문 1 & 2(English Composition)와 심리학 개론, 사회학 개론, 역사학 및 철학 등 기초 교양 과목(GE Breadth)을 탄탄하게 이수하는 것이 첫걸음입니다.",
        tip: "💡 플랫폼 활용 팁: [02. 편입 요건 검색]을 통해 지원하려는 인문학과에서 요구하는 영어 작문 레벨 및 필수 제2외국어 이수 면제 기준을 파악하십시오."
      },
      {
        title: "체계적인 교양 패스웨이(GE Pathway) 준수 (GE Pathway)",
        body: "많은 주립대(예: UC 계열의 IGETC)는 인문사회계열 지원 시 전체 교양 이수 패키지를 완료한 학생을 우선 선발합니다. 학기별 과목 선택 시, 해당 대학군이 규정하는 영역별(인문, 사회, 과학, 예술) 학점을 골고루 취득해야 합니다.",
        tip: "💡 플랫폼 활용 팁: 본인이 소속된 CC의 교양 과정이 목표 주립대의 전체 교양 패키지와 어떻게 매핑되는지 꼼꼼하게 검토하십시오."
      },
      {
        title: "독서/작문 과목 분산 배치 및 내신 관리 (Academic Scheduling)",
        body: "글쓰기와 독서 과제가 많은 인문사회 전공 특성상, 한 학기에 레포트 제출 과목이 너무 많이 겹치면 GPA 유지가 어려워집니다. 학기별로 과목 성격을 안배해 균형 있는 내신(GPA) 관리를 이어나가야 합니다.",
        tip: "💡 플랫폼 활용 팁: [03. 수강 로드맵 빌더]를 사용하여 영작문 및 인문학 강의들을 무리하지 않게 적절한 시퀀스로 고르게 배치해 보십시오."
      },
      {
        title: "학술 연구, 작문 포트폴리오 및 SOP 에세이 (Qualitative Assets)",
        body: "인문/사회과학 편입에서는 학업 목적 진술서(SOP)의 비중이 매우 높습니다. 수업 중 작성한 우수 에세이, 교수진과의 학술 연구 어시스턴트 활동, 또는 관련 봉사 경험을 학문적 관심사와 융합해 매끄러운 영문 에세이로 완성해 내야 합니다.",
        tip: "💡 플랫폼 활용 팁: [04. AI 에세이 전략가] 기능을 활용해 자신의 인문학적 탐구 성과와 전공 적합성을 매끄러운 학술적 톤앤매너로 서술해 보십시오."
      }
    ]
  }
};
...
function loadProfileFromLocalStorage() {
  try {
    ...
    if (profile.track !== undefined) {
      state.track = profile.track;
      state.strategyTrack = profile.track;
    }
...
function checkPlanAccess(tabName) {
  return true; // Allow entering all tabs to let Free users view the interface
}

function updateTabLockStates() {
  const isPremium = (state.plan || "Free") === "Premium";
  const reqLock = qs("#requirementsLockOverlay");
  const roadLock = qs("#roadmapLockOverlay");
  ...
  if (essayLock) {
    const hasCredits = (state.essayCredits || 0) > 0;
    const pendingPasses = (state.pendingPasses || 0) > 0;
    const targetSchoolInput = qs("#essayTargetSchool");
    const targetSchool = targetSchoolInput ? targetSchoolInput.value.split("-")[0].trim() : "";
    const isSchoolUnlocked = targetSchool && Array.isArray(state.unlockedSchools) && state.unlockedSchools.includes(targetSchool);
    
    const essayUnlocked = isPremium || hasCredits || pendingPasses || isSchoolUnlocked;
    essayLock.classList.toggle("hidden", essayUnlocked);
  }
}
...
function applyPlanUpgrade(plan, forceCredits = null) {
  ...
  if (currentUser) {
    ...
    if (plan === "Premium") {
      state.essayCredits = 1;
      localStorage.setItem("transferCompassEssayCredits", "1");
    } else {
...
function getMajorCategoryKey(name) {
  const n = name.toLowerCase();
  if (n.includes("computer science") || n.includes("cs")) return "cs";
  if (n.includes("computer engineering")) return "ce";
  if (n.includes("electrical")) return "ee";
  if (n.includes("mechanical")) return "me";
  if (n.includes("chemical")) return "cheme";
  if (n.includes("biomedical") || n.includes("bioengineering")) return "bioeng";
  if (n.includes("biochemistry") || n.includes("biochem")) return "biochem";
  if (n.includes("biology") || n.includes("biological")) return "biology";
  if (n.includes("chemistry") || n.includes("chem")) return "chemistry";
  if (n.includes("mathematics") || n.includes("math")) return "math";
  if (n.includes("physics")) return "physics";
  if (n.includes("business") || n.includes("finance") || n.includes("accounting") || n.includes("management") || n.includes("commerce") || n.includes("haas") || n.includes("경영")) return "business";
  if (n.includes("economics") || n.includes("economy") || n.includes("경제")) return "economics";
  if (n.includes("psychology") || n.includes("심리")) return "psychology";
  return "other";
}

function isMajorMatching(progMajorName, caseMajorName) {
  if (!progMajorName || !caseMajorName) return false;
  const pCat = getMajorCategoryKey(progMajorName);
  const cCat = getMajorCategoryKey(caseMajorName);
  if (pCat !== "other" || cCat !== "other") {
    return pCat === cCat;
  }
...
function uniqueSchools() {
  ...
  const additionalSchools = (window.AllUSUniversities || [])
    .filter(name => !verifiedNames.has(name.toLowerCase()))
    .map(name => ({
...
function programsForSchoolName(schoolName) {
  ...
  if (matchedPrograms.length > 0) {
    return matchedPrograms.sort((a, b) => (a.name || "").localeCompare(b.name || ""));
  }
  
  // 2. If it is an unverified school, dynamically inject mock majors into database.schools
  const isKo = (state.language || "ko") === "ko";
  const mockSchoolId = schoolName.toLowerCase().replace(/[^a-z0-9]/g, "-");
  
  let existingSchool = database.schools.find(s => s.name.toLowerCase() === schoolName.toLowerCase());
  if (!existingSchool) {
    existingSchool = {
      id: mockSchoolId,
      name: schoolName,
    ...
    const mockMajors = [
      {
        id: `${mockSchoolId}-computer-science`,
        name: isKo ? "Computer Science (컴퓨터 과학)" : "Computer Science",
        rawMinGpa: "3.50 minimum recommended GPA",
        rawMinCredits: "60 transferable semester credits",
        minGpa: 3.5,
        minCredits: 60,
        requiredCourses: [
          "MATH 1 - Calculus I",
          "MATH 2 - Calculus II",
          "COMP 1 - Introduction to Programming (CS1)",
          "COMP 2 - Data Structures (CS2)",
          "English Composition I"
        ],
        recommendedCourses: [
          "MATH 3 - Calculus III",
          "MATH 4 - Linear Algebra",
          "PHYS 1 - Physics (Mechanics)"
        ],
        english: {
          raw: isKo ? "TOEFL iBT: 최소 80점 | IELTS: 최소 6.5 | Duolingo DET: 최소 115점" : "TOEFL iBT: Min 80 | IELTS: Min 6.5 | Duolingo DET: Min 115",
          TOEFL: 80,
          TOEFL_2026: 4.5,
          IELTS: 6.5,
          Duolingo: 115
        },
        englishExemption: "US Higher Education Completed",
        note: isKo ? "AI 예측 데이터: 본 요건은 해당 대학의 일반적인 컴퓨터 과학 편입 권장 조건을 바탕으로 AI가 자동 시뮬레이션한 데이터입니다. 실제 지원 시 공식 요강을 확인하십시오." 
                   : "AI-Generated: This profile is dynamically simulated based on typical Computer Science transfer requirements. Please verify with the official admissions guide.",
        confidence: "ai_generated",
        officialSourceUrl: `https://www.google.com/search?q=${encodeURIComponent(schoolName + ' transfer computer science prerequisites')}`
      },
      {
        id: `${mockSchoolId}-business-administration`,
        name: isKo ? "Business Administration (경영학)" : "Business Administration",
        rawMinGpa: "3.30 minimum recommended GPA",
        rawMinCredits: "60 transferable semester credits",
        minGpa: 3.3,
        minCredits: 60,
        requiredCourses: [
        ...
        englishExemption: "US Higher Education Completed",
        note: isKo ? "AI 예측 데이터: 본 요건은 해당 대학의 일반적인 경영학 편입 권장 조건을 바탕으로 AI가 자동 시뮬레이션한 데이터입니다. 실제 지원 시 공식 요강을 확인하십시오." 
                   : "AI-Generated: This profile is dynamically simulated based on typical Business transfer requirements. Please verify with the official admissions guide.",
        confidence: "ai_generated",
        officialSourceUrl: `https://www.google.com/search?q=${encodeURIComponent(schoolName + ' transfer business administration prerequisites')}`
      },
      {
        id: `${mockSchoolId}-psychology`,
        name: isKo ? "Psychology (심리학)" : "Psychology",
        rawMinGpa: "3.20 minimum recommended GPA",
        rawMinCredits: "60 transferable semester credits",
        minGpa: 3.2,
        minCredits: 60,
        requiredCourses: [
          "PSYC 1 - Introduction to Psychology",
          "MATH 5 - Introductory Statistics",
        ...
        englishExemption: "US Higher Education Completed",
        note: isKo ? "AI 예측 데이터: 본 요건은 해당 대학의 일반적인 심리학 편입 권장 조건을 바탕으로 AI가 자동 시뮬레이션한 데이터입니다. 실제 지원 시 공식 요강을 확인하십시오." 
                   : "AI-Generated: This profile is dynamically simulated based on typical Psychology transfer requirements. Please verify with the official admissions guide.",
        confidence: "ai_generated",
        officialSourceUrl: `https://www.google.com/search?q=${encodeURIComponent(schoolName + ' transfer psychology prerequisites')}`
      }
    ];
    
    existingSchool.majors = mockMajors;
    database.schools.push(existingSchool);
  }
  
  return existingSchool.majors.map(m => ({
    ...m,
    school: existingSchool,
    university: existingSchool
...
function renderCourseGroups() {
  ...
  const track = state.track || "stem";
  let order = [];
  if (track === "stem") {
    order = ["Math", "Physics", "Chemistry", "Science", "English", "Computer", "Engineering"];
  } else if (track === "business") {
    order = ["Math", "Business", "English"];
  } else { // humanities
    order = ["Math", "SocialSciences", "Humanities", "English"];
  }

  const buildHtml = (idSuffix) => {
    return order
      .filter((category) => groups[category]?.length)
      .map(
        (category) => {
          const displayTitle = t("cat_" + category.toLowerCase(), category);
          return `
                  ...
                  .map(
                    (course) => `
                      <label class="course-row compact-course">
                        ...
                        <input type="checkbox" data-course="${escapeHtml(course.id)}" data-suffix="${idSuffix}" ${
  ...
  const courseGroupsEl = qs("#courseGroups");
  if (courseGroupsEl) {
    courseGroupsEl.innerHTML = buildHtml("tab1");
  }

  const roadmapCourseGroupsEl = qs("#roadmapCourseGroups");
  if (roadmapCourseGroupsEl) {
    roadmapCourseGroupsEl.innerHTML = buildHtml("tab3");
  }
  ...
  qsa("[data-course]").forEach((checkbox) => {
    checkbox.addEventListener("change", () => {
      ...
      if (checkbox.checked) {
        ...
        state.completedCourses.delete(courseId);
      }
      
      // Real-time synchronization between tabs
      qsa(`[data-course="${courseId}"]`).forEach((other) => {
...
function activateProductTab(tabName, shouldScroll = true) {
  ...
  qsa('.mobile-nav-item').forEach(btn => btn.classList.remove('active'));
  const activeNavBtn = qs('#btnMobileNav' + tabName.charAt(0).toUpperCase() + tabName.slice(1));
...
function renderRequirementControls() {
  sortedPrograms = allPrograms().sort(
...
function getSchoolShortName(schoolName, isKo) {
  const norm = schoolName.toLowerCase();
  if (norm.includes("berkeley")) return isKo ? "UC 버클리" : "UC Berkeley";
  if (norm.includes("ucla")) return isKo ? "UCLA" : "UCLA";
  if (norm.includes("michigan")) return isKo ? "미시간대" : "U-Mich";
  if (norm.includes("washington") || norm.includes("uw")) return isKo ? "워싱턴대" : "UW";
  if (norm.includes("georgia institute") || norm.includes("georgia tech")) return isKo ? "조지아텍" : "Georgia Tech";
  if (norm.includes("columbia")) return isKo ? "컬럼비아대" : "Columbia";
  if (norm.includes("stanford")) return isKo ? "스탠포드대" : "Stanford";
  if (norm.includes("mit") || norm.includes("massachusetts institute")) return isKo ? "MIT" : "MIT";
  if (norm.includes("harvard")) return isKo ? "하버드대" : "Harvard";
  if (norm.includes("yale")) return isKo ? "예일대" : "Yale";
  if (norm.includes("princeton")) return isKo ? "프린스턴대" : "Princeton";
  if (norm.includes("caltech") || norm.includes("california institute of technology")) return isKo ? "칼텍" : "Caltech";
  if (norm.includes("cornell")) return isKo ? "코넬대" : "Cornell";
  if (norm.includes("pennsylvania") || norm.includes("upenn")) return isKo ? "UPenn" : "UPenn";
  if (norm.includes("chicago")) return isKo ? "시카고대" : "UChicago";
  if (norm.includes("northwestern")) return isKo ? "노스웨스턴대" : "Northwestern";
  if (norm.includes("duke")) return isKo ? "듀크대" : "Duke";
  if (norm.includes("johns hopkins")) return isKo ? "존스홉킨스대" : "JHU";
  
  let clean = schoolName.replace(/University of /i, "").replace(/ Campus/i, "").replace(/ 캠퍼스/i, "");
  return clean;
}

function getMajorShortName(majorName, isKo) {
  const norm = majorName.toLowerCase();
  if (norm.includes("computer science") || norm.includes("cs")) return isKo ? "컴공" : "CS";
  if (norm.includes("computer engineering")) return isKo ? "컴퓨터공학" : "Computer Eng";
  if (norm.includes("electrical")) return isKo ? "전자공학" : "EE";
  if (norm.includes("mechanical")) return isKo ? "기계공학" : "Mechanical Eng";
  if (norm.includes("chemical")) return isKo ? "화학공학" : "Chemical Eng";
  if (norm.includes("business") || norm.includes("haas") || norm.includes("경영")) return isKo ? "경영학" : "Business";
  if (norm.includes("economics") || norm.includes("경제")) return isKo ? "경제학" : "Economics";
  if (norm.includes("psychology") || norm.includes("심리")) return isKo ? "심리학" : "Psychology";
  if (norm.includes("mathematics") || norm.includes("math")) return isKo ? "수학" : "Math";
  if (norm.includes("physics")) return isKo ? "물리" : "Physics";
  return majorName.replace(/\([^)]+\)/g, "").trim();
}

function getIndividualizedActivities(program, track, isKo) {
  const schoolShort = getSchoolShortName(program.school.name, isKo);
  const majorShort = getMajorShortName(program.name, isKo);
  
  // Decide school-specific research assistant terminology
  let raTerm = isKo ? "학부 연구생 프로그램(UROP/URAP)" : "Undergraduate Research Opportunity (UROP/URAP)";
  const normSchool = program.school.name.toLowerCase();
  if (normSchool.includes("berkeley")) {
    raTerm = isKo ? "UC 버클리 URAP(학부생 리서치 지원 프로그램)" : "UC Berkeley URAP (Undergraduate Research Apprentice Program)";
  } else if (normSchool.includes("mit")) {
    raTerm = isKo ? "MIT UROP(학술 연구 프로그램)" : "MIT UROP (Undergraduate Research Opportunity Program)";
  } else if (normSchool.includes("stanford")) {
    raTerm = isKo ? "스탠포드 학부 리서치 프로그램(CURIS 등)" : "Stanford Undergraduate Research Program (CURIS/RA)";
  } else if (normSchool.includes("ucla")) {
    raTerm = isKo ? "UCLA URSP(학부생 리서치 학회 연구)" : "UCLA URSP (Undergraduate Research Scholar Program)";
  }

  if (track === "CS") {
    return isKo ? [
      `입학처 지향 인재상: ${schoolShort} ${majorShort}에 최적화된 기술적 문제해결사 및 실천가`,
      `${schoolShort} CS 관련 연구실의 ${raTerm} 또는 개별 연구 보조(RA) 참여`,
      `${majorShort} 분야 오픈소스 기여 및 고유의 실무 포트폴리오(웹/앱 프로덕트 런칭) 구축`,
      `${schoolShort} 지원 전공 경쟁력을 보여줄 수 있는 해커톤/알고리즘 경진대회 참가 및 입상`,
      `교내 컴퓨터 학술 소모임 리더 또는 ${majorShort} 기초 과목 피어 튜터 활동`
    ] : [
      `Admissions Persona: Technical problem solver and builder optimized for ${schoolShort} ${majorShort}`,
      `Participating as a Research Assistant (RA) via ${schoolShort} ${raTerm}`,
      `Contributing to open-source and building a practical ${majorShort} portfolio (e.g., launching web/mobile apps)`,
      `Competing and placing in hackathons or algorithm contests targeting ${schoolShort} standards`,
      `Serving as a campus computer science club leader or tutoring students in ${majorShort} fundamentals`
    ];
  } else if (track === "Math") {
    return isKo ? [
      `입학처 지향 인재상: ${schoolShort} ${majorShort} 학업 성과를 이론적으로 증명하는 수학적 모델러`,
      `${schoolShort} 수학과 연계 세미나 연구 보조 및 분석 리포트 공동 작성`,
      `수학/통계 피어 튜터링(Calculus, Linear Algebra) 활동 및 우수 강사 표창`,
      `Kaggle 등 글로벌 데이터 경쟁대회 참여 및 정량적 수치 분석 실적 확보`,
      `${schoolShort}의 수학적 엄밀성에 부합하는 학술 논문 번역 및 요약 포트폴리오 제작`
    ] : [
      `Admissions Persona: Mathematical modeler theoretically proving academic potential for ${schoolShort} ${majorShort}`,
      `Assisting in mathematics research seminars or co-writing analytical abstracts at ${schoolShort}`,
      `Tutoring students in calculus/statistics at the student academic success center with peer tutor awards`,
      `Participating in global ML competitions (Kaggle) showing quantitative analytics`,
      `Creating a research paper analysis portfolio demonstrating the rigor of ${schoolShort} ${majorShort}`
    ];
  } else if (track === "Physics") {
    return isKo ? [
      `입학처 지향 인재상: ${schoolShort} ${majorShort} 연구 방향에 맞춘 실험 및 이론 연구원`,
      `${schoolShort} 물리학 랩 학부 연구 보조원(RA) 및 첨단 실험 장비 데이터 수집`,
      `현대 물리학 스터디 동호회 개설 및 관련 분야 학술 세미나 주최`,
      `물리학 관련 기초 과목(일반물리, 미적분학) 학내 튜터링 기여`,
      `${schoolShort}의 리서치 테마에 맞춘 고급 전자기학/양자역학 분석 포트폴리오 구축`
    ] : [
      `Admissions Persona: Experimental and theoretical researcher aligned with ${schoolShort} ${majorShort}`,
      `Serving as a physics lab research assistant (RA) at ${schoolShort} managing experimental data`,
      `Founding modern physics study groups and presenting seminar topics`,
      `Tutoring students in general physics and calculus at campus success centers`,
      `Advanced electromagnetism or quantum mechanics study portfolio matching ${schoolShort} research`
    ];
  } else if (track === "Engineering") {
    return isKo ? [
      `입학처 지향 인재상: 설계 도면을 실제 프로토타입으로 완성하는 ${schoolShort} ${majorShort}형 엔지니어`,
      `${schoolShort} 공학/로보틱스 랩 인턴십 및 실무 메이커스페이스 장비 튜터 활동`,
      `FSAE(자작자동차) 또는 로보틱스 소모임 소속 실제 차량/로봇 프레임 설계 및 제어부 모델링`,
      `기계 설계 및 CAD 공모전 참여, 3D 프린팅 프로토타입 설계 포트폴리오 제작`,
      `미국 기계학회(ASME) 등 학생 포럼 참가 및 공동 발표 경력`
    ] : [
      `Admissions Persona: Practical engineer converting design blueprints into live prototypes for ${schoolShort} ${majorShort}`,
      `Research assistant in engineering/robotics labs at ${schoolShort} and tutoring at makerspaces`,
      `Modeling and control system design of FSAE racing cars or competitive robotics frames`,
      `Placing in CAD design contests and constructing 3D printing mechanism portfolios`,
      `Co-presenting at student engineering forums (such as ASME) or obtaining certified CAD credentials`
    ];
  } else if (track === "BioChem") {
    return isKo ? [
      `입학처 지향 인재상: 가설을 끈기 있게 검증하며 안전 규정을 준수하는 ${schoolShort} ${majorShort} 실험가`,
      `${schoolShort} 바이오/화학 연구실 풀타임 연구 보조원(RA) 및 정밀 시약 분석 참여`,
      `HPLC, NMR 등 고가 분석 기기를 다루는 실험 분석 포트폴리오 구축`,
      `학내 생명과학 저널 편집위원 참여 및 학생 학술지 리뷰 논문 게재`,
      `국제 합성생물학 대회(iGEM) 팀원으로 참가 및 바이오 기획 프로젝트 입상`
    ] : [
      `Admissions Persona: Biochemical analyst verifying hypotheses for ${schoolShort} ${majorShort}`,
      `Undergraduate researcher (RA) in biochemistry/biology laboratories at ${schoolShort}`,
      `Precision laboratory portfolio with hands-on experience using HPLC/NMR equipment`,
      `Serving as an editor for life sciences journals and publishing student reviews`,
      `Participating in synthetic biology competitions (iGEM) or bio-tech projects`
    ];
  } else if (track === "Business") {
    return isKo ? [
      `입학처 지향 인재상: 글로벌 마켓 트렌드를 분석하고 조직을 이끄는 ${schoolShort} ${majorShort}형 리더`,
      `${schoolShort}의 비즈니스 케이스 전략 공모전 참가 및 마케팅/재무 분석 제안서 작성`,
      `교내 금융/투자/컨설팅 학회 대표 회장 및 실제 펀드 시뮬레이션 포트폴리오 리드`,
      `이커머스/핀테크 스타트업 공동 창업 및 실제 벤처캐피탈(VC) 피칭 경험`,
      `글로벌 기업 인턴십 경력 및 소상공인 대상 비즈니스 솔루션 기여 프로젝트`
    ] : [
      `Admissions Persona: Strategic business leader driving capital and market trends globally for ${schoolShort} ${majorShort}`,
      `Participating in business case competitions and submitting strategic proposals for ${schoolShort}`,
      `President of student finance/investment societies leading simulated fund portfolios`,
      `Co-founding a startup with experience presenting pitch decks to venture capitalists`,
      `Corporate internship experience at global firms or business consulting for local startups`
    ];
  } else if (track === "Economics") {
    return isKo ? [
      `입학처 지향 인재상: 정량 데이터로 자원 배분과 정책을 모델링하는 ${schoolShort} ${majorShort} 분석가`,
      `${schoolShort}의 경제학 리서치 방향에 맞춘 R/Python 계량경제 분석 리포트 기획`,
      `학내 경제 토론 학회 대표 및 정기 간행 시사 경제 평론 리드`,
      `금융감독원/한국은행 등 금융 공공기관 대학생 서포터즈 및 모니터링 보조`,
      `정부/사회 정책의 경제적 인과관계 추론 모델링 연구 포스터 제작`
    ] : [
      `Admissions Persona: Quantitative analyst modeling resource allocation and policies for ${schoolShort} ${majorShort}`,
      `Econometric analysis reports using R/Python aligned with ${schoolShort} economics research`,
      `President of campus economics forum publishing bi-weekly analysis columns`,
      `Participating as a youth supporter or assistant in financial regulatory bodies`,
      `Modeling economic impacts of public policies using causal inference research posters`
    ];
  } else if (track === "Psychology") {
    return isKo ? [
      `입학처 지향 인재상: 과학적 실험과 임상적 공감을 조화롭게 다루는 ${schoolShort} ${majorShort} 관찰자`,
      `${schoolShort} 임상/인지 심리학 랩 학부 연구 보조(Lab Assistant) 및 IRB 승인 준비`,
      `종합사회복지관/심리상담센터 상담 보조 및 위기 대응 멘토 봉사활동 80시간 이상`,
      `행동 데이터 분석 툴(SPSS/R) 활용 연구 포스터 작성 및 학회 발표`,
      `학내 심리 건강 인식 개선 캠페인 대표 및 APA 등 학생 포럼 참가`
    ] : [
      `Admissions Persona: Scientific observer balancing clinical insights with human empathy for ${schoolShort} ${majorShort}`,
      `Research assistant in clinical/cognitive psychology labs at ${schoolShort} with IRB protocol experience`,
      `80+ hours of counseling assistant services and volunteer work at community support centers`,
      `Presenting academic research posters based on statistical behavioral data (SPSS/R)`,
      `Leader of campus mental health campaign and attending APA student seminars`
    ];
  } else {
    return isKo ? [
      `입학처 지향 인재상: 비판적 텍스트 독해와 인문학적 고찰로 의제를 선도하는 ${schoolShort} ${majorShort} 지성`,
      `${schoolShort} 전공 관련 인문학/사회과학 학술 연구 번역 및 문헌 아카이빙 기여`,
      `글로벌 NGO 단체 인턴십 및 모의 UN 세미나 참가 대학 대표`,
      `교내 영자 신문사 편집장 또는 학내 평론 고정 칼럼 집필`,
      `지역 사회 교육 기부 프로그램 리더 또는 사회적 가치 에세이 공모전 입상`
    ] : [
      `Admissions Persona: Intellectual leader driving cultural agendas via critical text analysis for ${schoolShort} ${majorShort}`,
      `Assisting in humanities/social sciences research literature translation and archiving at ${schoolShort}`,
      `Internship at global NGOs and participating in simulated UN youth summits`,
      `Editor-in-chief of campus English newspaper writing regular political/cultural columns`,
      `Leading community educational donation projects or winning national humanities essay contests`
    ];
  }
}
...
function getCompetitiveProfile(program) {
  ...
  let recLettersKo = "권장 (1부)";
  let admissionRate = "15% - 25%";
  let competitiveEnglish = "TOEFL 90+ / IELTS 7.0";
  
  const isTopTier = schoolName.includes("berkeley") || 
                    schoolName.includes("ucla") || 
                    schoolName.includes("michigan") || 
                    schoolName.includes("georgia institute") || 
                    schoolName.includes("columbia") || 
                    schoolName.includes("cornell") || 
                    schoolName.includes("nyu") || 
                    schoolName.includes("usc") || 
  ...
  if (isTopTier) {
    ...
    const isMidTier = schoolName.includes("illinois") || 
                      ...
                      schoolName.includes("washington") || 
                      schoolName.includes("wisconsin") || 
  ...
  activities = getIndividualizedActivities(program, track, isKo);
...
function getAdmissionsSchoolId(schoolName) {
  const norm = schoolName.toLowerCase();
  if (norm.includes("berkeley")) return "university-of-california-berkeley";
  if (norm.includes("washington")) return "university-of-washington";
  if (norm.includes("georgia institute") || norm.includes("georgia tech")) return "georgia-institute-of-technology";
  if (norm.includes("michigan")) return "university-of-michigan-ann-arbor";
...
function generateMockCases(program, compProfile, lang) {
  const isKo = lang === "ko";
  const schoolName = program.school.name;
  const majorName = program.name;
  
  let ccOrigin = isKo ? "커뮤니티 칼리지 (CC)" : "Community College (CC)";
  const normSchool = schoolName.toLowerCase();
  if (normSchool.includes("california") || normSchool.includes("berkeley") || normSchool.includes("ucla")) {
    ccOrigin = isKo ? "캘리포니아 커뮤니티 칼리지 (CC)" : "California Community College (CC)";
  } else if (normSchool.includes("washington")) {
    ccOrigin = isKo ? "워싱턴주 커뮤니티 칼리지 (CC)" : "Washington Community College (CC)";
  } else if (normSchool.includes("michigan")) {
    ccOrigin = isKo ? "미시간주 커뮤니티 칼리지 (CC)" : "Michigan Community College (CC)";
  }

  let gpa1 = "3.91";
  let gpa2 = "3.85";
  if (compProfile.gpaRange) {
    const parts = compProfile.gpaRange.split("-");
    if (parts.length === 2) {
      const min = parseFloat(parts[0]);
      const max = parseFloat(parts[1]);
      if (!isNaN(min) && !isNaN(max)) {
        gpa1 = (max - 0.05).toFixed(2);
        gpa2 = ((min + max) / 2).toFixed(2);
      }
    }
  }

  const outcomeStr = isKo ? `합격 (${schoolName} ${majorName})` : `Accepted (${schoolName} ${majorName})`;
  ...
  return [
    ...
    },
    {
      ...
      major: majorName,
      gpa: gpa2,
      origin: isKo ? "4년제 대학교" : "4-Year University",
      outcome: outcomeStr,
      international: isKo ? "아니오" : "No",
      extra: extra2,
      isMock: true
    }
  ];
...
async function renderRequirementDetail(programId) {
  ...
  if (targetCases.length === 0) {
    isSimulated = true;
    targetCases = generateMockCases(program, compProfile, lang);
  }
  ...
  const rateParts = [];
  if (stats.rateOverall) rateParts.push(`${isKo ? "전체" : "Overall"} ${stats.rateOverall}`);
  if (stats.rateInState) rateParts.push(`${isKo ? "주내" : "In-State"} ${stats.rateInState}`);
  if (stats.rateOutOfState) rateParts.push(`${isKo ? "타주" : "Out-of-State"} ${stats.rateOutOfState}`);
  if (stats.rateInternational) rateParts.push(`${isKo ? "국제" : "Int'l"} ${stats.rateInternational}`);
  
  let finalAdmissionRate = "";
  if (rateParts.length > 0) {
    finalAdmissionRate = rateParts.join(" | ");
  } else {
    finalAdmissionRate = compProfile.admissionRate ? `${compProfile.admissionRate} (${isKo ? "예상" : "Est."})` : "N/A";
  }
  ...
  if (targetCases.length > 0) {
    ...
    if (firstCase.keyElectives) {
      if (Array.isArray(firstCase.keyElectives)) {
        finalElectives = firstCase.keyElectives;
      } else {
        finalElectives = firstCase.keyElectives.split(",").map(s => s.trim());
      }
    }
  }

  const requiredCourseNames = new Set(summary.required.mapped.map(c => c.name.toLowerCase().trim()));
  recommendedMapped = finalElectives
    .filter(name => !requiredCourseNames.has(name.toLowerCase().trim()))
    .map(name => {
      let category = isKo ? "권장 선수과목" : "Recommended";
      const nameLower = name.toLowerCase();
      if (nameLower.includes("calc") || nameLower.includes("math") || nameLower.includes("algebra") || nameLower.includes("probability")) {
        category = isKo ? "수학" : "Mathematics";
      } else if (nameLower.includes("physic") || nameLower.includes("mechanic") || nameLower.includes("electromagnetism") || nameLower.includes("statics") || nameLower.includes("dynamics")) {
        category = isKo ? "물리/공학" : "Physics/Engineering";
      } else if (nameLower.includes("chem") || nameLower.includes("organic")) {
        category = isKo ? "화학" : "Chemistry";
      } else if (nameLower.includes("biol") || nameLower.includes("biochem")) {
        category = isKo ? "생물" : "Biology";
      } else if (nameLower.includes("cs") || nameLower.includes("programming") || nameLower.includes("data structure") || nameLower.includes("discrete")) {
        category = isKo ? "컴퓨터 과학" : "Computer Science";
      } else if (nameLower.includes("econ") || nameLower.includes("macro") || nameLower.includes("micro")) {
        category = isKo ? "경제학" : "Economics";
      } else if (nameLower.includes("stat")) {
        category = isKo ? "통계학" : "Statistics";
      } else if (nameLower.includes("cad") || nameLower.includes("modeling") || nameLower.includes("design")) {
        category = isKo ? "공학 설계" : "Engineering Design";
      }
      return {
        name: name,
        category: category,
        isLab: nameLower.includes("lab")
      };
    });
          ...
          ${targetCases.map((c, idx) => `
            <div style="background: rgba(255,255,255,0.015); border: 1px solid var(--line); border-radius: 8px; padding: 12px; font-size: 13px;">
              ...
              <div style="margin-top: 6px; font-size: 12px; color: var(--muted); line-height: 1.5; background: rgba(0,0,0,0.1); padding: 8px; border-radius: 4px;">
                💡 <strong>${isKo ? "주요 활동 & 스펙" : "Key Activities"}:</strong> ${c.extra}
              </div>
            </div>
          `).join("")}
        </div>
  ...
  const compProfileHtml = `
    <article class="requirement-card" style="border-left: 4px solid var(--accent); background: rgba(255, 255, 255, 0.01);">
      <h3 style="color: var(--accent); display: flex; align-items: center; gap: 8px; font-size: 14.5px; font-weight: 800; margin-bottom: 12px;">
        <span>🎓</span> ${isKo ? "명문대 합격생 스펙 & 카운슬러 가이드" : "Admissions Spec & Counselor Guide"}
      </h3>
      <p style="font-size: 13px; color: var(--muted); margin-bottom: 16px; line-height: 1.45;">
        ${isKo ? "수집된 공개 편입 결과 및 통계 데이터를 분석하여 산출된 권장 경쟁력 지표입니다." : "Recommended competitive metrics calculated based on compiled public transfer datasets and statistical profiles."}
      </p>
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 16px;">
        ...
        <div style="background: rgba(255,255,255,0.02); border: 1px solid var(--line); border-radius: 8px; padding: 8px 10px;">
          <span style="font-size: 10.5px; color: var(--muted); font-weight: 700; display: block; margin-bottom: 2px;">
            ${isKo ? "최근 5년 합격자 GPA" : "Recent 5-Year GPA Range"}
          </span>
          <strong style="color: var(--ink); font-size: 14.5px;">${finalGpaRange}</strong>
        </div>
        <div style="background: rgba(255,255,255,0.02); border: 1px solid var(--line); border-radius: 8px; padding: 8px 10px; grid-column: span 2;">
          <span style="font-size: 10.5px; color: var(--muted); font-weight: 700; display: block; margin-bottom: 2px;">
            ${isKo ? "실제 경쟁력 있는 영어 점수" : "Competitive English Score"}
          </span>
          <strong style="color: #fbbf24; font-size: 13.5px; font-weight: 800;">${finalEnglish}</strong>
        </div>
        <div style="background: rgba(255,255,255,0.02); border: 1px solid var(--line); border-radius: 8px; padding: 8px 10px;">
          <span style="font-size: 10.5px; color: var(--muted); font-weight: 700; display: block; margin-bottom: 2px;">
            ${isKo ? "에세이 반영 비중" : "Essay Importance"}
          </span>
          <strong style="color: #fbbf24; font-size: 14px;">${isKo ? compProfile.essayWeight : compProfile.essayWeightEn}</strong>
        </div>
        <div style="background: rgba(255,255,255,0.02); border: 1px solid var(--line); border-radius: 8px; padding: 8px 10px;">
          <span style="font-size: 10.5px; color: var(--muted); font-weight: 700; display: block; margin-bottom: 2px;">
            ${isKo ? "교수 추천서 요구사항" : "Recommendation Letters"}
          </span>
          <strong style="color: #3b82f6; font-size: 12.5px;">${isKo ? compProfile.recLettersKo : compProfile.recLetters}</strong>
        </div>
      </div>
      ...
      <div style="margin-bottom: 14px;">
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 6px;">
          ${finalElectives.map(e => `
            <span style="background: rgba(99, 102, 241, 0.08); border: 1px solid rgba(99, 102, 241, 0.2); border-radius: 4px; padding: 3px 8px; font-size: 12px; color: #4f46e5; font-weight: 500;">
              ${e}
            </span>
          `).join("")}
        </div>
      ...
      <div style="margin-bottom: 20px;">
        ...
        <ul style="margin: 0; padding-left: 18px; color: var(--muted); font-size: 12.5px; line-height: 1.6;">
          ${compProfile.activities.map(act => `
            <li>${act}</li>
          `).join("")}
        </ul>
      </div>

      ${casesHtml ? `<div style="border-top: 1px solid var(--line); padding-top: 20px; margin-top: 20px;">${casesHtml}</div>` : ""}
    </article>
  `;
    ...
    <article class="requirement-card" style="border-left: 4px solid var(--primary); display: flex; flex-direction: column; justify-content: space-between;">
      <div>
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 16px; flex-wrap: wrap; gap: 8px;">
          <div>
            <h2 style="font-size: 20px; font-weight: 800; color: var(--ink); margin: 0 0 4px 0; line-height: 1.2;">${escapeHtml(program.school.name)}</h2>
            <p style="font-size: 14.5px; color: var(--muted); margin: 0; font-weight: 500;">${escapeHtml(program.name)}</p>
          </div>
          <div>
            ${getConfidenceBadgeHtml(program)}
          </div>
        </div>

        ${
          verificationNotice
            ? `<div class="verification-alert" style="margin-bottom: 16px;">
                <strong>${escapeHtml(verificationNotice.label)}</strong>
                <span>${escapeHtml(verificationNotice.detail)}</span>
              </div>`
            : ""
        ...
        <p style="font-size: 13px; line-height: 1.5; color: var(--ink); margin-bottom: 20px;">
      ...
      <div style="border-top: 1px solid var(--line); padding-top: 20px; margin-top: 20px;">
        <h3 style="color: var(--primary); display: flex; align-items: center; gap: 8px; font-size: 14.5px; font-weight: 800; margin-bottom: 12px;">
        ...
        <div style="font-size: 12px; line-height: 1.5; background: rgba(244, 63, 94, 0.03); border-left: 3px solid #f43f5e; padding: 10px; border-radius: 0 6px 6px 0;">
          <strong style="color: #b91c1c; display: block; margin-bottom: 4px;">💡 수석 컨설턴트 핵심 전술 조언</strong>
  ...
  let courseChecklistHtml = "";
  if (isHolistic) {
    courseChecklistHtml = `
      <article class="requirement-card" style="border-left: 4px solid var(--accent);">
        <h3 style="color: var(--accent); display: flex; align-items: center; gap: 8px; font-size: 15px; font-weight: 800;">
          <span>ℹ️</span> ${escapeHtml(t("holistic_eval_title"))}
        </h3>
        <p style="font-size: 13.5px; line-height: 1.6; color: var(--ink); margin-top: 10px;">
    ...
    courseChecklistHtml = `
      <article class="requirement-card" style="border-left: 4px solid #6366f1;">
        <h3 style="font-size: 15px; font-weight: 800; margin-bottom: 16px; color: var(--ink); display: flex; align-items: center; gap: 8px;">
          <span>📚</span> ${isKo ? "선수과목 이수 진단 체크리스트" : "Prerequisite Course Checklist"}
        </h3>
        
        <div style="display: flex; flex-direction: column; gap: 20px;">
          <!-- Required Section -->
          <div>
            <h4 style="font-size: 13px; font-weight: 700; color: #ef4444; margin: 0 0 8px 0; display: flex; align-items: center; gap: 6px;">
              <span style="color: #ef4444;">●</span> ${t("section_required_title")}
            </h4>
            ${summary.required.mapped.length > 0 
              ? `<ul class="course-list">${renderMappedCourseList(summary.required.mapped)}</ul>` 
              : `<p style="font-size: 12.5px; color: var(--muted); margin: 0; padding-left: 10px;">${isKo ? "필수 이수 과목이 지정되어 있지 않습니다." : "No required courses specified."}</p>`
            }
          </div>

          <!-- Recommended Section -->
          <div>
            <h4 style="font-size: 13px; font-weight: 700; color: #10b981; margin: 0 0 8px 0; display: flex; align-items: center; gap: 6px;">
              <span style="color: #10b981;">●</span> ${t("section_recommended_title")}
            </h4>
            ${recommendedMapped.length > 0 
              ? `<ul class="course-list">${renderMappedCourseList(recommendedMapped)}</ul>` 
              : `<p style="font-size: 12.5px; color: var(--muted); margin: 0; padding-left: 10px;">${isKo ? "추천 권장 과목이 지정되어 있지 않습니다." : "No recommended courses specified."}</p>`
            }
          </div>

          <!-- Choices Section -->
          ${(summary.required.choices.length || recommendedChoices.length) ? `
            <div>
              <h4 style="font-size: 13px; font-weight: 700; color: #f59e0b; margin: 0 0 8px 0; display: flex; align-items: center; gap: 6px;">
                <span style="color: #f59e0b;">●</span> ${t("section_choices_title")}
              </h4>
              <ul class="course-list">${renderChoiceList([...summary.required.choices, ...recommendedChoices])}</ul>
            </div>
          ` : ""}

          <!-- Enroll Later Section -->
          ${(summary.required.later.length || recommendedLater.length) ? `
            <div>
              <h4 style="font-size: 13px; font-weight: 700; color: #3b82f6; margin: 0 0 8px 0; display: flex; align-items: center; gap: 6px;">
                <span style="color: #3b82f6;">●</span> ${t("section_enroll_title")}
              </h4>
          ...
          <!-- Review Section -->
          ${(summary.required.review.length || summary.recommended.review.length || englishReviewItems.length) ? `
            <div>
              <h4 style="font-size: 13px; font-weight: 700; color: #ec4899; margin: 0 0 8px 0; display: flex; align-items: center; gap: 6px;">
                <span style="color: #ec4899;">●</span> ${t("section_review_title")}
              </h4>
  ...
  const additionalAndCatalogHtml = `
    <article class="requirement-card" style="display: flex; flex-direction: column; gap: 20px;">
      <div>
        <h3 style="font-size: 15px; font-weight: 800; margin: 0 0 12px 0; color: var(--ink); display: flex; align-items: center; gap: 8px;">
          <span>ℹ️</span> ${t("section_extra_title")}
        </h3>
        <ul class="course-list">
          ${renderInfoList(additionalInfo)}
        </ul>
      </div>
      ...
      ${
        renderEnglishRequirementRows(program.english)
          ? `<div style="border-top: 1px solid var(--line); padding-top: 16px;">
              <h3 style="font-size: 14.5px; font-weight: 800; margin: 0 0 12px 0; color: var(--ink); display: flex; align-items: center; gap: 8px;">
                <span>🌐</span> English Language Requirements
              </h3>
              <div class="check-list" style="margin-bottom: 10px;">${renderEnglishRequirementRows(program.english)}</div>
              <p style="font-size: 12.5px; color: var(--muted); margin: 0; line-height: 1.45;">${escapeHtml(program.english?.raw === "Refer to official catalog wording below" ? t("refer_to_catalog_wording", "Refer to official catalog wording below") : (program.english?.raw || ""))}</p>
            </div>`
          : ""
      }

      ${
        program.rawOfficialText
          ? `<div style="border-top: 1px solid var(--line); padding-top: 16px;">
              <h3 style="font-size: 14.5px; font-weight: 800; margin: 0 0 12px 0; color: var(--ink); display: flex; align-items: center; gap: 8px;">
                <span>📝</span> 공식 요강 요약 & 원문 대조
              </h3>
              <p style="font-size: 12.5px; color: var(--muted); margin-bottom: 12px; line-height: 1.45;">
                ⚠️ AI 분석과 대조할 수 있도록 수집된 요강 원문을 요약하여 보여줍니다. 최종 지원 시에는 반드시 아래 링크의 대학교 공식 페이지를 한 번 더 확인하시기 바랍니다.
              </p>
              <div style="margin-bottom: 16px; padding: 14px; background: rgba(197, 168, 128, 0.04); border: 1px dashed rgba(197, 168, 128, 0.25); border-radius: 8px; font-size: 13px; color: var(--ink); line-height: 1.6;">
                ...
                <ul style="margin: 0; padding-left: 20px; list-style-type: disc;">
                  ...
                  <li><strong>Minimum Credits Requirement:</strong> ${escapeHtml(program.rawMinCredits || t("unspecified_credits"))}</li>
                  <li><strong>Key Prerequisites Mentioned:</strong> ${escapeHtml(program.requiredCourses?.length ? program.requiredCourses.join(", ") : "Refer to detailed checklist above")}</li>
                </ul>
              </div>
              <details style="border: 1px solid var(--line); border-radius: 8px; background: rgba(255, 255, 255, 0.02); padding: 12px; transition: all 0.2s;">
                <summary style="cursor: pointer; font-weight: 700; font-size: 13px; color: var(--accent); outline: none; user-select: none; display: flex; align-items: center; gap: 6px;">
                  📂 공식 모집 요강 원문 전체 보기 (View Full Text)
                </summary>
                <div class="raw-official-text-box" style="margin-top: 12px; max-height: 200px; overflow-y: auto; font-family: monospace; font-size: 12px; line-height: 1.6; white-space: pre-wrap; word-break: break-all; color: #bbb; border-top: 1px solid var(--line); padding-top: 12px;">${escapeHtml(program.rawOfficialText)}</div>
              </details>
  ...
  let detailHtml = `
    ${basicInfoAndStatsHtml}
    ${compProfileHtml}
    ${courseChecklistHtml}
    ${additionalAndCatalogHtml}
  `;
...
function getStudentTrack(selectedPrograms) {
  if (selectedPrograms.length === 0) return "STEM";
  ...
  if (hasHumanities) return "Humanities";
  return "STEM";
}
...
function renderAdvisoryMilestones(termStr, track, isInternational) {
  const milestones = getAdvisoryMilestones(termStr, track, isInternational);
  if (milestones.length === 0) {
    const isKo = (state.language || "ko") === "ko";
    return `<div style="color: var(--muted); font-size: 12.5px; padding: 10px 0;">
      ${isKo ? "방학/기타 학기는 학업 관리 및 휴식을 권장하며, 목표 대학 요강 체크를 병행해 주세요." : "Focus on academic prep and check target guidelines during buffer terms."}
    </div>`;
  }
  return milestones.map(m => `
    <div style="background: rgba(255,255,255,0.02); border: 1px solid var(--line); border-radius: 8px; padding: 10px 12px; font-size: 12.5px; display: grid; gap: 4px;">
      <div style="display: flex; align-items: center; justify-content: space-between;">
        <span style="font-size: 10px; font-weight: 800; color: ${m.color}; background: ${m.color}18; padding: 2px 6px; border-radius: 4px; text-transform: uppercase;">
          ${escapeHtml(m.badge)}
        </span>
      </div>
...
function buildRoadmap(explicit = false) {
  ...
  const rawQueue = [
    fixedEnglish1 && !isCourseSatisfied("eng-comp-1") && { ...fixedEnglish1, priority: "english", label: t("roadmap_eng_first_term") },
    fixedEnglish2 && !isCourseSatisfied("eng-comp-2") && { ...fixedEnglish2, priority: "english", label: t("roadmap_eng_second_term") },
          ...
          <article class="term-card dual-timeline-card" style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; padding: 20px; align-items: start; background: #ffffff; border: 1px solid var(--line); border-radius: 12px; box-shadow: var(--shadow-soft);">
            ...
            <div class="advisory-col" style="border-left: 1px solid var(--line); padding-left: 24px;">
              <h3 style="margin-bottom: 12px; border-bottom: 2px solid var(--line); padding-bottom: 8px; display: flex; align-items: center; gap: 8px; font-size: 15px; font-weight: 800; color: #f59e0b;">
                <span style="font-size: 18px;">🎯</span> ${isKo ? "비교과 & 원서 마일스톤" : "Advisory & App Milestones"}
              </h3>
              <div class="advisory-milestones" style="display: flex; flex-direction: column; gap: 10px;">
                ${advisoryHtml}
              </div>
            </div>
          </article>
...
function bindEvents() {
  ...
  qs("#clearCoursesBtn")?.addEventListener("click", clearAllCourses);
  qs("#roadmapClearCoursesBtn")?.addEventListener("click", clearAllCourses);
...
function syncUserEssayCredits(currentUser, authState) {
  if (currentUser === "haminkim@uwm.edu") {
    ...
    authState.users[currentUser].pendingPasses = 999999;
    authState.users[currentUser].unlockedSchools = authState.users[currentUser].unlockedSchools || [];
    state.pendingPasses = 999999;
    state.unlockedSchools = authState.users[currentUser].unlockedSchools;
    localStorage.setItem("transferCompassPendingPasses", "999999");
  ...
  state.pendingPasses = userProfile.pendingPasses || 0;
  state.unlockedSchools = userProfile.unlockedSchools || [];
...
function renderSchoolCoverage() {
  ...
  summary.innerHTML = `
    ...
    <div>
      <strong>100%</strong>
      <span>${escapeHtml(t("stat_programs", "Major Coverage (AI Real-time)"))}</span>
    </div>
    <div>
...
function updateEssayCreditsUI() {
  ...
  const pendingCountEl = qs("#essayPendingPassesCount");
  if (pendingCountEl) {
    pendingCountEl.textContent = state.pendingPasses || 0;
  }
  const unlockedListEl = qs("#unlockedSchoolsList");
  if (unlockedListEl && state.unlockedSchools.length > 0) {
    const isKo = (state.language || "ko") === "ko";
    unlockedListEl.innerHTML = `${isKo ? "활성화된 대학" : "Unlocked Universities"}: <strong style="color: #10b981;">${state.unlockedSchools.join(", ")}</strong>`;
  } else if (unlockedListEl) {
    unlockedListEl.innerHTML = "";
  }
  
  // also update profile modal if opened
  const profileCreditsVal = qs("#profileCreditsVal");
  if (profileCreditsVal) {
    profileCreditsVal.textContent = `${state.essayCredits} (Passes: ${state.pendingPasses || 0})`;
  }
  updateTabLockStates();
}
...
function updateEssaySchoolStatusUI() {
  ...
  if (!schoolSelect || !statusEl) return;
...
function applyEssayCreditsPurchase() {
  ...
  const currentUser = authState.currentUser || "";
  if (currentUser) {
    authState.users[currentUser].pendingPasses = (authState.users[currentUser].pendingPasses || 0) + 1;
    writeAuthState(authState);
    state.pendingPasses = authState.users[currentUser].pendingPasses;
  } else {
    state.pendingPasses = (state.pendingPasses || 0) + 1;
  }
  localStorage.setItem("transferCompassPendingPasses", state.pendingPasses.toString());
  updateEssayCreditsUI();
...
function renderSideDrawerUserSection() {
  ...
  if (!currentUser) {
    container.innerHTML = `
      <div style="display: flex; flex-direction: column; gap: 8px;">
        <p style="font-size: 12px; color: var(--muted); margin: 0;">${isEn ? "Log in to access your customized course plans and AI essay tools." : "로그인하시면 개인 맞춤 수강계획 및 AI 에세이 기능을 사용하실 수 있습니다."}</p>
        <div style="display: flex; gap: 8px; margin-top: 4px;">
          <button class="secondary-btn compact" style="flex: 1; min-height: 30px; font-size: 11px; padding: 4px;" onclick="closeSideDrawer(); openAuthModal('login');">${isEn ? "Log In" : "로그인"}</button>
          <button class="primary-btn compact" style="flex: 1; min-height: 30px; font-size: 11px; padding: 4px;" onclick="closeSideDrawer(); openAuthModal('signup');">${isEn ? "Sign Up" : "회원가입"}</button>
        </div>
      </div>
    `;
    return;
  ...
  const plan = userProfile.plan || "Free";
  const displayPlan = plan === "Premium" ? "Premium" : (isEn ? "Free Plan" : "무료 플랜");
  const credits = state.essayCredits;
  const displayCredits = credits === 999999 ? (isEn ? "Unlimited" : "무제한") : credits + (isEn ? " credits" : "회");
  ...
  container.innerHTML = `
    ...
    <div class="user-credits" style="margin-bottom: 12px;">
      <span>✉️ ${isEn ? "AI Essay Credits" : "AI 에세이 크레딧"}: <strong>${displayCredits}</strong></span>
    </div>
    <div style="display: flex; gap: 8px; margin-top: 8px;">
      <button type="button" class="secondary-btn compact" style="flex: 1; min-height: 30px; font-size: 11px; padding: 4px;" onclick="closeSideDrawer(); openProfileModal();">${isEn ? "My Profile" : "내 프로필"}</button>
      <button type="button" class="secondary-btn compact" style="flex: 1; min-height: 30px; font-size: 11px; padding: 4px;" onclick="closeSideDrawer(); handleLogout();">${isEn ? "Log out" : "로그아웃"}</button>
    </div>
  `;
}
...
function renderStrategyTimeline() {
  const container = qs(".guide-timeline");
  if (!container) return;
  const lang = state.language || "en";
  ...
  container.innerHTML = steps.map((step, index) => {
    ...
    return `
      <div class="guide-card">
        ...
        <div style="display: flex; flex-direction: column; gap: 8px;">
          <h3 style="font-size: 18px; font-weight: 800; color: var(--ink); margin: 0;">${step.title}</h3>
...
window.renderStrategyTimeline = renderStrategyTimeline;
...
window.updateSortedPrograms = updateSortedPrograms;

function openOnDemandScrapeModal(schoolName = "", majorName = "") {
  const modal = qs("#generateReqModal");
  if (modal) {
    qs("#genSchoolName").value = schoolName;
    qs("#genMajorName").value = majorName;
    qs("#genMessage").textContent = "";
    qs("#genMessage").className = "feedback-status";
    qs("#genLoader").classList.add("hidden");
    qs("#genSubmitBtn").disabled = false;
    modal.classList.remove("hidden");
  }
}
window.openOnDemandScrapeModal = openOnDemandScrapeModal;

function openOnDemandScrapeWithQuery(query) {
  let school = "";
  let major = "";
  ...
  openOnDemandScrapeModal(school, major);
}
window.openOnDemandScrapeWithQuery = openOnDemandScrapeWithQuery;

function closeOnDemandScrapeModal() {
  const modal = qs("#generateReqModal");
  if (modal) modal.classList.add("hidden");
}
window.closeOnDemandScrapeModal = closeOnDemandScrapeModal;

async function handleOnDemandScrape(event) {
  event.preventDefault();
  const schoolName = qs("#genSchoolName").value.trim();
  const majorName = qs("#genMajorName").value.trim();
  const msgEl = qs("#genMessage");
  const loaderEl = qs("#genLoader");
  const submitBtn = qs("#genSubmitBtn");
  
  if (!schoolName || !majorName) return;
  
  msgEl.textContent = "";
  msgEl.className = "feedback-status";
  ...
  try {
    ...
    if (result.success) {
      ...
      const existingMajorIdx = localSchool.majors.findIndex(m => m.name.toLowerCase() === majorName.toLowerCase());
      ...
      // 2. Re-render select options and lists
      updateSortedPrograms();
      ...
      msgEl.textContent = state.language === "ko" ? "성공적으로 요건을 분석하여 데이터베이스에 반영했습니다!" : "Successfully generated and added prerequisites to the database!";
      msgEl.className = "feedback-status success";
      
      // Close modal after 1.5 seconds
      setTimeout(() => {
        closeOnDemandScrapeModal();
      }, 1500);
      
    } else {
      msgEl.textContent = (state.language === "ko" ? "생성 실패: " : "Generation failed: ") + result.message;
      msgEl.className = "feedback-status error";
    }
  } catch (err) {
    msgEl.textContent = (state.language === "ko" ? "서버 통신 오류: " : "Server communication error: ") + err.message;
    msgEl.className = "feedback-status error";
  } finally {
...
window.handleOnDemandScrape = handleOnDemandScrape;

function handleMobileBottomNav(tabName) {
  // Update UI active state
  qsa('.mobile-nav-item').forEach(btn => btn.classList.remove('active'));
  const activeBtn = qs('#btnMobileNav' + tabName.charAt(0).toUpperCase() + tabName.slice(1));
  if (activeBtn) activeBtn.classList.add('active');

  if (tabName === 'pricing') {
    // Scroll to landing pricing
    const landingPricing = qs('#landing-pricing');
    if (landingPricing) {
      landingPricing.scrollIntoView({ behavior: 'smooth', block: 'start' });
    }
  } else {
    // Activate tab
    activateProductTab(tabName, true);
  }
}
