...
// Write to JSON
fs.writeFileSync(path.join(__dirname, '..', 'scratch', 'prereqs_summary.json'), JSON.stringify(summary, null, 2), 'utf8');
console.log(`Audited ${summary.length} majors. Wrote to scratch/prereqs_summary.json.`);

// Print majors with 0 or 1 requirement
console.log("\n--- Majors with 0 or 1 prerequisite course requirement ---");
