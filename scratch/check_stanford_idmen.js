...
if (stanford) {
  const idmen = stanford.majors.find(m => m.id.includes('IDMEN'));
  if (idmen) {
    console.log("IDMEN-BS requiredCourses:", idmen.requiredCourses);
    idmen.requiredCourses.forEach(raw => {
    ...
    console.log("IDMEN-BS major not found");
  }
}
